...
const services: { icon: string; title: string; body: React.ReactNode; price: string }[] = [
  {
    icon: 'lightbulb',
    title: '照明器具の交換・新設',
    body: <>シーリングライト・ダウンライト・スポットライトなどの照明器具交換・新設に対応します。<br />LED化工事もお任せください。</>,
    price: '¥8,800〜',
  },
  {
    icon: 'power',
    title: 'コンセント・スイッチ増設',
    body: <>コンセントの増設・移設や、スイッチの交換・追加工事を行います。<br />タコ足配線の解消にもご活用ください。</>,
    price: '¥11,000〜',
  },
  {
    icon: 'air',
    title: '換気扇・レンジフード交換',
    body: <>キッチンのレンジフードや浴室・トイレの換気扇の交換に対応します。<br />臭い・音の改善につながります。</>,
    price: '¥13,200〜',
  },
  {
    icon: 'dry',
    title: '浴室乾燥機の取付',
    body: <>浴室暖房乾燥機の新規取付・交換工事です。<br />電気式・ガス式どちらにも対応しています。</>,
    price: '¥22,000〜',
  },
  {
    icon: 'water_heater',
    title: '洗面台・水栓の交換',
    body: <>洗面化粧台の入替や水栓金具の交換工事を行います。<br />水漏れ・老朽化にも迅速対応します。</>,
    price: '¥16,500〜',
  },
  {
    icon: 'electric_meter',
    title: '電気容量アップ・分電盤交換',
    body: <>古い分電盤の交換やアンペアアップ工事に対応します。<br />IH導入時の電気容量増設もお任せください。</>,
    price: '¥33,000〜',
  },
]
        ...
        <section className="bg-surface-container-low rounded-2xl p-10 md:p-16 flex flex-col md:flex-row items-center gap-8">
          ...
          <div>
            ...
            <p className="text-on-surface-variant leading-relaxed">
              ここに掲載していない工事についても対応できる場合があります。<br />
              「こんなこと頼めるの？」と思ったことでも、<br />
              まずはお電話またはお問い合わせフォームでご相談ください。<br />
              対応可否のご確認だけでも構いません。
            </p>
          </div>
        </section>
