...
export const metadata: Metadata = {
  title: '流山市のエアコン・給湯器・コンロ取付 | 合同会社ライフチェンジ',
  description: '流山市のエアコン取付・給湯器交換・コンロ取付は合同会社ライフチェンジへ。松戸市拠点で近い。最短当日対応。050-5536-8619',
}
...
const areas = [
  '流山', '南流山', '流山おおたかの森', '初石', '豊四季', '江戸川台',
  '平和台', '鰭ヶ崎', '運河', '東初石', '西初石', '向小金新田',
]

export default function NagareyamaPage() {
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-8 relative z-10">
          <div className="md:w-2/3">
            ...
            <p className="text-on-primary-container text-lg leading-relaxed mb-10 max-w-xl">
              松戸市に拠点を置く当社は、流山市にも迅速に対応可能です。<br />
              おおたかの森・南流山・初石エリアなど、<br />
              流山市全域でエアコン・給湯器・コンロ工事を承ります。
            </p>
      ...
      <main className="max-w-7xl mx-auto px-8 py-20 space-y-20">
        ...
        {/* Services */}
        <section>
          <h2 className="text-3xl font-black text-primary font-headline mb-8">流山市での対応サービス</h2>
        ...
        {/* Coverage area */}
        <section>
          <h2 className="text-3xl font-black text-primary font-headline mb-4">流山市内の対応エリア</h2>
          <p className="text-on-surface-variant mb-6">流山市内全エリアに対応しています。</p>
        ...
        <section className="bg-primary text-white rounded-2xl p-12 text-center">
          <h2 className="text-3xl font-black font-headline mb-4">流山市のお客様、<br className="sm:hidden" />お気軽にどうぞ</h2>
          <p className="text-on-primary-container mb-8 leading-relaxed">現地調査・お見積もりは無料。迅速に対応します。</p>
